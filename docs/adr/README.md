...
| [ADR-007](ADR-007-repository-layout-seven-top-level-folders.md) | Repository layout: seven top-level folders, one-way dependencies | Accepted, amended 2026-08-29 | 
